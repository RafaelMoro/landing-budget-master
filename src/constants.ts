...
export const BUDGET_MASTER_APP_URL = 'https://budget-master.app.space'
...
export const BUDGET_MASTER_EMAIL = 'sugerencias-quejas@budget-master.space'
export const BUDGET_MASTER_SEND_EMAIL = `mailto:${BUDGET_MASTER_EMAIL}`